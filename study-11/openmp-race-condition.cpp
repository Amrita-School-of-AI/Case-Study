...
int main()
{
    ...
    int private_counter = 10;
    int lastprivate_counter = 10;
    int firstprivate_counter = 10;
...
#pragma omp parallel shared(shared_counter) private(private_counter) firstprivate(firstprivate_counter)
    {
...
#pragma omp parallel for lastprivate(lastprivate_counter)
...
#pragma omp single
        {
            std::cout << "In parallel region inside for loop:" << std::endl;
            std::cout << "Shared counter: " << shared_counter << std::endl;
            std::cout << "Private counter: " << private_counter << std::endl;
            std::cout << "Lastprivate counter: " << lastprivate_counter << std::endl;
            std::cout << "Firstprivate counter: " << firstprivate_counter << std::endl;
